        ...
        <View style={[this.props.innerContainerStyle, styles.innerContainer]}>
          ...
          <TouchableOpacity
            ...
            onPress={this.props.tabThreeBtn.action}>
              <CompanionIcon
                style={{
                  // color: (this.props.isActive == 'tabThree') ? this.props.tabThreeBtn.active : this.props.tabThreeBtn.inactive,
          ...
          <TouchableOpacity
            ...
            onPress={this.props.tabFourBtn.action}>
              <MemberIcon
                style={{
                  // color: (this.props.isActive == 'tabFour') ? this.props.tabFourBtn.active : this.props.tabFourBtn.inactive,
