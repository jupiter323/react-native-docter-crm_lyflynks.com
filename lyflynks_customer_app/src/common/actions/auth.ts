  ...
  return async dispatch => {
    ...
    try {
      ...
      if(response.success === true) {
        ...
        console.log("Get token auth call:", AsyncStorage.getItem('device_token'));
        console.log("Get token await auth call:", await AsyncStorage.getItem('device_token'));

        if(has_device_token_been_posted == 'false'&& deviceToken != null) {
          console.log('token to call auth', deviceToken);
          ...
          console.log('Not calling auth as device token is null');
